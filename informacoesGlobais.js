...
async function vizualizarInformacoesGlobais() {
    ...
    aproximadamente <span>${pessoasConectadas} bilhoes</span> estão conectadas em alguma rede social e passam em média <span>${horas}</span> horas e <span>${minutos}</span> minutos 
    conectadas.
